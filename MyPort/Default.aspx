<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MyPort.Index" %>
...
<html>
    <head>
                ...
                $("#aboutUSSubmit").click(function (e) {
                    ...
                    if (true == true) {
                        $.ajax({
                            ...
                            data: '{"name":"hell","email":"test@test.com"}',
                            dataType: "json",
        ...
        <!-- Tweaks for older IEs--><!--[if lt IE 9]>https://developer.wordnik.com/
    ...
    <body>
        ...
        <header class="header">
            <nav class="navbar navbar-expand-lg fixed-top">
                <div class="container"><a href="#intro" class="navbar-brand scrollTo headerHref">SManju</a>
...
<a class="dropdown-item" href="blogs/sqlblogs.html">JS and jQuery Blogs</a>-->

                                    <!--  <a class="dropdown-item" href="#">Travel Blogs</a>-->
                                </div>
                            </li>
                            <!--  <li class="nav-item"><a href="cgi-bin/Fun.py" class="nav-link link-scroll">Just For Fun</a></li>-->
        ...
        <section id="intro" style="background: url(img/home.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
            <div class="container text-center">
                <div data-animate="fadeInDown" class="logo"><img src="img/logo.png" alt="logo" height="auto" width="60%"></div>
                            ...
                            <form id="contactform" method="post"  runat="server">
                                ...
                                <div class="controls">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="comment" class="form-control" placeholder="Message for me *" rows="4" required="required"></textarea>
                                        </div>
